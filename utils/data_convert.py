...
def generate_samples(savepath, data, graph, train_rate=0.6, val_rate=0.2, test_rate=0.2, val_test_mix=False):
...
#     graph = nx.from_numpy_matrix(np.load(osp.join("/home/s223719687/python_project/traffic_evolve/data/PeMS7_Evolve/daily/graph", f"{str(week)}_adj.npz"))["x"])
#     generate_samples(osp.join("/home/s223719687/python_project/traffic_evolve/data/PeMS7_Evolve/daily/FastData/", f"{str(week)}_30day"), np.load(osp.join("/home/s223719687/python_project/traffic_evolve/data/PeMS7_Evolve//daily/final_data", f"{str(week)}.npz"))["x"], graph, val_test_mix=True)